...
<section class="quick-view">
   ...
   <img src="uploaded_files/<?= $fetch_product['image']; ?>" alt="Product Image">
   ...
   <div class="button-container">
      <a href="view_products.php" class="btn products-btn">Back</a>
      <a href="add_rating.php?pid=<?= $product_id; ?>" class="btn rating-btn">Add Rating</a>
   </div>
</div>
