...
$sql = "SELECT id, model_name, image FROM models WHERE brand_id = ? AND id BETWEEN 3025 AND 3030 AND status = 1";
...
$brand_id = 1005; // Assuming 1005 is the brand_id for Audi
...
<section class="section featured-car" id="car-makers">
    <div class="container">
        ...
        <div class="title-wrapper">
            <h2 class="h2 section-title">Audi</h2>
        </div>
