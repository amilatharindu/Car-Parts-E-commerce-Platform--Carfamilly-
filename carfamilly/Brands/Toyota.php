...
$sql = "SELECT id, model_name, image FROM models WHERE brand_id = ? AND id BETWEEN 3001 AND 3006 AND status = 1";
                ...
                <li>
                    <div class="featured-car-card">
                        <figure class="card-banner">
                            <img src="/carfamilly/admin_panel/uploads/<?php echo htmlspecialchars($model['image']); ?>" alt="<?php echo htmlspecialchars($model['model_name']); ?>" loading="lazy" class="w-100">
                        </figure>
