...
$sql = "SELECT id, model_name, image FROM models WHERE brand_id = ? AND id BETWEEN 3019 AND 3024 AND status = 1";
...
$brand_id = 1004; // Assuming 1004 is the brand_id for BMW
...
<section class="section featured-car" id="car-makers">
    <div class="container">
        ...
        <div class="title-wrapper"> 
            <h2 class="h2 section-title">BMW</h2>
        </div>
