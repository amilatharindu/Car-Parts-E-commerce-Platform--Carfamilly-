...
$sql = "SELECT id, model_name, image FROM models WHERE brand_id = ? AND id BETWEEN 3013 AND 3018 AND status = 1";
...
$brand_id = 1003; // Assuming 1003 is the brand_id for Nissan
...
<section class="section featured-car" id="car-makers">
    <div class="container">
        ...
        <div class="title-wrapper"> 
            <h2 class="h2 section-title">Nissan</h2>
        </div>
