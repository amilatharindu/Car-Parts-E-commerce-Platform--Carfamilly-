...
$sql = "SELECT id, model_name, image FROM models WHERE brand_id = ? AND id BETWEEN 3007 AND 3012 AND status = 1";
...
$brand_id = 1002; // Assuming 1002 is the brand_id for Honda
...
<section class="section featured-car" id="car-makers">
    <div class="container">
        ...
        <div class="title-wrapper"> 
            <h2 class="h2 section-title">Honda</h2>
        </div>
