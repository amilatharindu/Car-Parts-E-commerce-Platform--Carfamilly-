...
if (isset($_POST['submit'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $warning_msg[] = '<p style="font-size: 20px; color: red;">Enter a valid email address</p>';
    } else {
        ...
        if ($check_rating->rowCount() > 0) {
            ...
            // Remove the manual ID generation, assuming 'id' is auto-increment
            $add_rating = $conn->prepare("INSERT INTO `ratings` (product_id, rating, review, first_name, last_name, email) VALUES (?, ?, ?, ?, ?, ?)");
            if ($add_rating->execute([$product_id, $rating, $description, $first_name, $last_name, $email])) {
...
<section class="container">
    ...
    <form action="" method="post">
        ...
        <a href="view_products.php" class="option-btn">Back to Products</a>
    </form>
</section>
</body>
</html>
